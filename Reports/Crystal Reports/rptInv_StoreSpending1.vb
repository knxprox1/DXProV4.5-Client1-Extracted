...
Public Class rptInv_StoreSpending
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInv_StoreSpending.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EBS.Inventory.rptInv_StoreSpending.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PrintPrice() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptInv_StoreSpending
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInv_StoreSpending = New rptInv_StoreSpending()
        rpt.Site = Me.Site
        Return rpt
    End Function
