...
Public Class rptInv_BillSample
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EBS.Purchasing.rptInv_BillSample.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInv_BillSample
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInv_BillSample = New rptInv_BillSample()
        rpt.Site = Me.Site
        Return rpt
    End Function
